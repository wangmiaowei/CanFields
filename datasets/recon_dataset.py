...
class ReconDataset(data.Dataset):
    ...
    def __init__(self, file_path, n_points, n_samples=128, res=128, sample_type='grid', sapmling_std=0.005,
        ...
        #v, _, n = pcu.load_mesh_vfn(self.file_path, dtype=np.float32)
...
if __name__ == "__main__":
    ...
    dataset = ReconDataset(file_path, n_points, n_samples, res, sample_type, 0.005)
    slice = int(res/2)
